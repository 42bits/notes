...
function _M.return_success(data, msg)
    return {
        OPT_STATUS = true,
        DATA = data,
        OPT_STATUS_CH = msg
...
function _M.return_fail(data, msg)
    return {
        OPT_STATUS = true,
        DATA = data,
        OPT_STATUS_CH = msg
...
function _M.json_success(data, msg)
    return cjson.encode(_M.return_success(data, msg))
end

function _M.json_fail(data, msg)
    return cjson.encode(_M.return_fail(data, msg))
end
